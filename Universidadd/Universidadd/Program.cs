...
namespace Universidad
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Persona Danna = fabricapersonas.getPersona("alumno");
            ...
            Danna.setDatos("Kasandra", "Cuellar", Sexo.Femenino, "05/04/2001", 7156587, "kasandra@gmail.com");
            Console.WriteLine(Danna.getDatos());
            FabricaAulas fabricaaulas = new FabricaAulas();

            Aula a202 = fabricaaulas.getAula("teoria", null);
            a202.setDatos("A202", new Ubicacion(1, 2), new Tamaño(3, 4), 30);
